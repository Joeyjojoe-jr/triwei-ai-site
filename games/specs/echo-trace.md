---
layout: game_spec
title: "Echo Trace - Mini Spec"
slug: echo-trace
kind: game
game_url: /games/echo-trace/
permalink: /games/specs/echo-trace/
tags: ['memory', 'sequence', 'attention']
difficulty: medium
...
## Learning Lens
Focus on memory, sequence, attention and how local actions shape global behavior.
...
- Declared unique asset: `games/echo-trace/index.html`
