---
layout: game_spec
title: "Grid Hopper - Mini Spec"
slug: grid-hopper
kind: game
game_url: /games/grid-hopper/
permalink: /games/specs/grid-hopper/
tags: ['path-planning', 'state-space', 'puzzle']
difficulty: medium
...
## Learning Lens
Focus on path-planning, state-space, puzzle and how local actions shape global behavior.
...
- Declared unique asset: `games/grid-hopper/index.html`
