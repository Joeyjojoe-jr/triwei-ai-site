---
layout: game_spec
title: "Q-Learning Maze Runner - Mini Spec"
slug: labs/qlearning-grid
kind: lab
game_url: /games/labs/qlearning-grid/
permalink: /games/specs/labs/qlearning-grid/
tags: ['reinforcement-learning', 'q-learning', 'policy']
difficulty: hard
session_length: "8-14 min"
...
## Learning Lens
Focus on reinforcement-learning, q-learning, policy and how local actions shape global behavior.
...
- Declared unique asset: `games/labs/qlearning-grid/index.html`
