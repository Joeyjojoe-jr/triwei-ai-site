---
layout: game_spec
title: "Logic Lattice - Mini Spec"
slug: logic-lattice
kind: game
game_url: /games/logic-lattice/
permalink: /games/specs/logic-lattice/
tags: ['constraints', 'parity', 'logic']
difficulty: hard
session_length: "4-8 min"
...
## Learning Lens
Focus on constraints, parity, logic and how local actions shape global behavior.
...
- Declared unique asset: `games/logic-lattice/index.html`
