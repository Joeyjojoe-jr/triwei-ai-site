---
layout: game_spec
title: "Pulse Stack - Mini Spec"
slug: pulse-stack
kind: game
game_url: /games/pulse-stack/
permalink: /games/specs/pulse-stack/
tags: ['timing', 'precision', 'stacking']
difficulty: medium
...
## Learning Lens
Focus on timing, precision, stacking and how local actions shape global behavior.
...
- Declared unique asset: `games/pulse-stack/index.html`
